        ...
        if _G.AutoBuild == true then
            pcall(function()
                for i,v in pairs(game:GetService("Workspace").Tycoons[game.Players.LocalPlayer.Name].Buttons:GetDescendants()) do
                    if v.Name ~= "Air StrikeAir Strike" and v:IsA("Model") and v:FindFirstChild("Button") then
                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.Button.CFrame
                        wait(5)
                    elseif v.Name == "Air StrikeAir Strike" and v:IsA("Model") and v:FindFirstChild("Button") then
                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.Button.CFrame
                        wait(5)
                    end
                end
